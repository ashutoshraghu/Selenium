...
public class BV_PA_PendingPayer extends ExtentReportClass{
...
//		
//		// PA Status - Approved
//		driver.findElement(By.xpath("//*[@id=\"mat-radio-13\"]")).click();
//
//		driver.findElement(By.id("saveAndNext")).click();
//
//	
...
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_PA_PendingPayer.getScreenshot(driver,result.getName());
