...
public class BV_InProcess extends ExtentReportClass{
	...
	public void Check_Benefit() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"mat-option-193\"]/span")).click();
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_InProcess.getScreenshot(driver,result.getName());
