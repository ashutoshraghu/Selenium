...
public class BV_PA_Cancelled extends ExtentReportClass{
...
//		
//		// PA Status - Approved
//		driver.findElement(By.xpath("//*[@id=\"mat-radio-16\"]")).click();
//
//		driver.findElement(By.id("saveAndNext")).click();
//
//	}
...
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_PA_Cancelled.getScreenshot(driver,result.getName());
