...
public class Copay extends ExtentReportClass{
	...
	public void Assigned_Faxes() throws InterruptedException {
		...
		// Check Copay
		driver.findElement(By.xpath("//*[@id=\"mat-checkbox-2\"]/label")).click();
	...
	public void Copay() throws InterruptedException {
...
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = Copay.getScreenshot(driver,result.getName());
