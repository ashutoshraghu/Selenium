...
public class BV_NotCovered extends ExtentReportClass{
	...
	public void Check_Benefit() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"mat-option-191\"]/span")).click();
...
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_NotCovered.getScreenshot(driver,result.getName());
