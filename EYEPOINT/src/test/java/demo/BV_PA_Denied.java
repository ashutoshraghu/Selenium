...
public class BV_PA_Denied extends ExtentReportClass{
...
//		
//		// PA Status - Approved
//		driver.findElement(By.xpath("//*[@id=\"mat-radio-15\"]")).click();
//
//		driver.findElement(By.id("saveAndNext")).click();
//
//	}
...
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_PA_Denied.getScreenshot(driver,result.getName());
