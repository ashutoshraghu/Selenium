...
public class PAP_Approved extends ExtentReportClass{
	...
	public void Assigned_Faxes() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"mat-checkbox-3\"]/label")).click();
	...
	public void Service_Validation() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"mat-select-24\"]/div/div[1]/span")).click();

		// Select Enrollment
		driver.findElement(By.xpath("//*[@id=\"mat-option-103\"]/mat-pseudo-checkbox")).click();   
	...
	public void PAP() throws InterruptedException {

		Thread.sleep(3000);

		// PAP BUTTON
		driver.findElement(By.xpath("//*[@id=\"cdk-accordion-child-16\"]/div/mat-card/button/span")).click();

		// Missing info
		driver.findElement(By.xpath("//*[@id=\"mat-radio-17\"]/label/div[1]/div[1]")).click();

		// Save and Next
		driver.findElement(By.xpath("saveAndNext")).click();
	...
	//
	//		// RTME  
	//		driver.findElement(By.xpath("//*[@id=\"mat-select-39\"]/div/div[1]/span")).click();
	//		driver.findElement(By.xpath("//*[@id=\"mat-option-168\"]/span")).click();
	//
	...
	//
	//		// BV Outcome
	//		driver.findElement(By.xpath("//*[@id=\"mat-select-47\"]/div/div[1]/span")).click();
	//		driver.findElement(By.xpath("//*[@id=\"mat-option-196\"]/span")).click();
	//
	//		//java script executor object 
	...
	//
	//		// CheckBox
	//		driver.findElement(By.xpath("//*[@id=\"mat-radio-18\"]/label/div[1]/div[1]")).click();
	//
	//		//Proceed Button
	//		driver.findElement(By.xpath("//*[@id=\"cdk-accordion-child-43\"]/div/mat-card/button/span")).click();	
	//
	//	}
	//
	...
	//
	//		// Fax Number
	//		driver.findElement(By.xpath("//*[@id=\"mat-input-66\"]")).sendKeys("000-000-0000");
	//
	//		driver.findElement(By.id("saveAndNext")).click();
	//
	//	}
	...
	//
	//		// Email Id
	//		driver.findElement(By.xpath("//*[@id=\"mat-input-67\"]")).sendKeys("abc@gmail.com");
	//
	//		driver.findElement(By.id("saveAndNext")).click();
	//
	//	}
	//	@Test(priority =25, dependsOnMethods = "KAM_Email")
	//	public void Triage() throws InterruptedException {
	//
	//		// Preferred Pharmacy
	//		driver.findElement(By.xpath("//*[@id=\"mat-select-67\"]")).click();
	//		driver.findElement(By.xpath("//*[@id=\"mat-option-281\"]/span")).click();
	//
	//		driver.findElement(By.id("saveAndNext")).click();
	//
	//	}
	//
	//	@Test(priority =26, dependsOnMethods = "Triage")
	//	public void Pharmacy_Fax() throws InterruptedException {
	//
	//		// Fax Number
	//		driver.findElement(By.xpath("//*[@id=\"mat-input-127\"]")).sendKeys("000-000-0000");
	//
	//		driver.findElement(By.id("saveAndNext")).click();
	//
	//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = PAP_Approved.getScreenshot(driver,result.getName());
