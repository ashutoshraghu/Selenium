...
public class BV_PA_Approved extends ExtentReportClass{
	...
	public void Open_AppianRx() {
		...
		driver.get("http://localhost:4200/#/analyst");
	...
	public void Check_Benefit() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"mat-option-194\"]/span")).click();
...
//		
//		// PA Status - Approved
//		driver.findElement(By.xpath("//*[@id=\"mat-radio-14\"]")).click();
//
//		driver.findElement(By.id("saveAndNext")).click();
//
//	}
//
//
//	@Test(priority =26, dependsOnMethods = "PA")
//	public void Triage() throws InterruptedException {
//
//		// Preferred Pharmacy
//		driver.findElement(By.xpath("//*[@id=\"mat-select-69\"]")).click();
//		driver.findElement(By.xpath("//*[@id=\"mat-option-285\"]/span")).click();
//
//		driver.findElement(By.id("saveAndNext")).click();
//
//	}
//
//	@Test(priority =27, dependsOnMethods = "Triage")
//	public void Pharmacy_Fax() throws InterruptedException {
//
//		// Fax Number
//		driver.findElement(By.xpath("//*[@id=\"mat-input-145\"]")).sendKeys("000-000-0000");
//
//		driver.findElement(By.id("saveAndNext")).click();
//
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_PA_Approved.getScreenshot(driver,result.getName());
