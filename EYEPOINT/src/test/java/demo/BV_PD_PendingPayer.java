...
public class BV_PD_PendingPayer extends ExtentReportClass{
	...
	public void Check_Benefit() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"mat-option-176\"]/span")).click();
		...
		// BV Outcome
		driver.findElement(By.xpath("//*[@id=\"mat-select-48\"]/div/div[1]/span")).click();
		driver.findElement(By.xpath("//*[@id=\"mat-option-209\"]/span")).click();
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_PD_PendingPayer.getScreenshot(driver,result.getName());
