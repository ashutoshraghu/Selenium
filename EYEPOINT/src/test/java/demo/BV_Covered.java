...
public class BV_Covered extends ExtentReportClass{
	...
	public void Check_Benefit() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"mat-option-190\"]/span")).click();
...
//	}
	...
	public void teardown(ITestResult result) throws IOException {
		...
		if(result.getStatus()== ITestResult.FAILURE)
		{
			...
			String screenshotPath = BV_Covered.getScreenshot(driver,result.getName());
